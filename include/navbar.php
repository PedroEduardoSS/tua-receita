<nav class="w3-bar w3-black">
    ...
    <a class="w3-bar-item w3-hover-grey w3-button w3-large w3-padding-16" href="../view/criar_receitas.php">CRIAR RECEITA</a>
    ...
    <div class="w3-dropdown-hover w3-right w3-hide-small">
        ...
        <div class="w3-dropdown-content w3-bar-block w3-card-4">
            <a href="../view/perfil.php" class="w3-bar-item w3-button w3-hover-blue">Perfil</a>
            <a href="../view/logout.php" class="w3-bar-item w3-button w3-hover-red">Sair</a>
        </div>
    </div>
...
<nav id="smallMenu" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium">
    <a class="w3-bar-item w3-hover-blue w3-button" href="perfil.php">Perfil</a>
